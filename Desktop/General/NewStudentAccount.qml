...
ESborder {
    ...
    onStateChanged: if(state == "inActive") {firstNameBox.text = ""
                                             lastNameBox.text = ""
                                             ageBox.text = ""
                                             bdayBox.text = ""
                                             aboutStudent.text = ""
    ...
    Column {
        ...
        Row {
            ...
            Button {
                ...
                text: if(view.currentIndex < view.count-1) {qsTr("Next")} else {qsTr("Okay")}


                onClicked: {

                    if(text == "Okay" && firstNameBox.text.length > 1 && lastNameBox.text.length > 1) {
